                ...
                <div class="col-md-12">
                 ...
                 <a class="btn btn-casier casier" href="<?php print site_url( 'projetos' ); ?>"><i class="glyphicon glyphicon-chevron-left"></i> Voltar</a>
                    <div id="ligacoes" class="tab-pane fade in active">
                        <button class="btn button-manzoni" onclick="add_register()"><i class="glyphicon glyphicon-plus"></i> Nova Pasta</button>
                    <?php } ?>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form">
                        <input type="hidden" name="fol_id"></input>
                        <input type="hidden" name="prj_id" value="<?php print $projeto->prj_id; ?>"></input>

                        <div class="row">
                         <div class="col-md-6">
                                <div class="form-group">
                                    <label for="field-1" class="control-label">Nome da Pasta</label>  
                                    <input type="text" autocomplete="off" class="form-control" id="fol_name" name="fol_name">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "ajax": {
                ...
                "type": "POST",
                "data": {prj_id: "<?php print $projeto->prj_id?> "}
